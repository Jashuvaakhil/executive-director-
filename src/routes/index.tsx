...
function Hero() {
  return (
    ...
    >
      <div className="relative mx-auto max-w-7xl px-6 pt-12 lg:pt-20 grid lg:grid-cols-2 gap-12 items-center lg:items-end">
        <div className="pb-16 lg:pb-24">
          <span className="inline-flex items-center gap-2 bg-transparent border border-[#171e19] text-[#171e19] rounded-full px-4 py-2 text-xs font-bold uppercase tracking-wider">
          ...
          <p className="mt-6 text-lg max-w-xl text-[#1A1A1A] font-medium">
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        <div className="max-w-5xl anim-box mx-auto text-center mb-20">
          <div className="flex flex-col items-center gap-3 mb-6 anim-content">
            <span className="text-[#c29b5a] text-xs font-bold uppercase tracking-[0.3em]">
          ...
          <p className="mt-6 text-lg font-medium text-neutral-900 anim-content max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto anim-grid">
          <div className="anim-box text-center">
            <div className="flex items-center justify-center gap-3 mb-6 anim-content">
              ...
              <span className="text-[#c29b5a] text-[10px] font-bold uppercase tracking-[0.25em]">
                Pillar One & Two
              </span>
              <div className="w-6 h-0.5 bg-[#c29b5a]"></div>
            </div>
            ...
            <p className="text-lg leading-relaxed text-neutral-900 font-medium anim-content">
        ...
        <div className="mt-10 pt-8 border-t border-black/5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-0 anim-grid relative">
          ...
          <div className="text-center anim-box relative flex flex-col items-center px-4">
            ...
            <span className="text-[#c29b5a] text-[9px] font-bold uppercase tracking-[0.2em] mb-3">
              Project Sites Executed
            </span>
            <p className="text-[11px] text-neutral-900 font-medium leading-relaxed max-w-[180px]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-24 lg:gap-32 items-start relative z-10">
          ...
          <div className="anim-box pt-4">
            <span className="inline-block text-sm font-bold uppercase tracking-[0.5em] text-[#c29b5a] mb-3 anim-content">
              LEADERSHIP
            </span>
            ...
            {items.map((it, idx) => (
              <div key={it.title} className="group relative anim-box grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                ...
                <div className="md:col-span-8">
                  <span className="text-[#c29b5a] text-2xl font-bold mb-3 block anim-content">{it.num}</span>
                  ...
                  <p className="text-neutral-400 text-sm leading-relaxed anim-content">
                    {it.body}
                  </p>
                </div>
                ...
                <div className="md:col-span-3 flex flex-col items-start gap-6 self-end pb-2">
                  ...
                  <div className="flex flex-col">
                    <span className="text-neutral-500 text-[10px] font-bold uppercase tracking-[0.25em] mb-1">
                      {it.label}
                    </span>
                  ...
                  <div key={i} className="flex flex-col md:flex-row items-center w-full relative timeline-item group min-h-[400px]">
                    ...
                    <div className={`w-full md:w-1/2 flex pl-20 md:pl-0 ${isEven ? 'md:justify-end md:pr-32' : 'md:justify-start md:pl-32 md:order-last'}`}>
                      <div className="timeline-card w-full max-w-md p-10 rounded-[24px] bg-white/70 backdrop-blur-xl border border-[#BFA77A]/30 shadow-[0_20px_50px_rgba(0,0,0,0.05)] transition-all duration-700 hover:border-[#BFA77A]/60 hover:bg-white/90">
                        <span className="text-[#c29b5a] text-[10px] font-bold uppercase tracking-[0.4em] mb-4 block opacity-70">
                          {s.title}
                        </span>
...
function RedSandParticles({ count = 350 }: { count?: number }) {
  const particles = Array.from({ length: count }).map((_, i) => {
    const size = Math.random() * 4 + 1; // Slightly larger for visibility: 1px to 5px
    const left = Math.random() * 100;
    const top = Math.random() * 100;
    const animDuration = Math.random() * 8 + 4; // Faster for better "moving" feel
    const animDelay = Math.random() * -15;

    // Deep Mining Red/Clay Dust Tones
    const colors = [
      '#b22222', // Firebrick Red
      '#8b0000', // Deep Dark Red
      '#a0522d', // Sienna (Red Clay)
      '#d2691e', // Chocolate Brown
      '#c2410c', // Burnt Orange/Iron
      '#7c2d12'  // Very Dark Earth
    ];
    ...
    return (
      <div
        ...
        style={{
          width: `${size}px`,
          height: `${size * (Math.random() * 0.3 + 0.9)}px`,
          left: `${left}%`,
          top: `${top}%`,
          ...
          animation: `sandStorm ${animDuration}s linear infinite`,
          animationDelay: `${animDelay}s`,
        }}
      />
    );
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
      {/* Background Glow - Reddish/Sandy tint */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#8b4513]/20 via-transparent to-transparent"></div>

      {/* Atmospheric Mist Clouds - Red Clay color */}
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-[10%] -left-[10%] w-[800px] h-[400px] bg-[#a0522d]/25 blur-[120px] animate-drift-slow" />
        <div className="absolute top-[50%] -right-[15%] w-[700px] h-[500px] bg-[#8b4513]/20 blur-[150px] animate-drift-slow" style={{ animationDirection: 'reverse' }} />
        <div className="absolute bottom-[0%] left-[20%] w-[900px] h-[300px] bg-[#b22222]/10 blur-[100px] animate-drift-slow" />
      </div>

      {/* Primary Particle Layer - High visibility red dust */}
      <div className="absolute inset-0 mix-blend-overlay opacity-80">
        {particles}
      </div>

      {/* High-Speed Iron Grains */}
      <div className="absolute inset-0 opacity-40 mix-blend-screen">
        {Array.from({ length: 150 }).map((_, i) => (
          <div
            key={`fine-${i}`}
            className="absolute bg-[#b22222]/30 rounded-full blur-[0.3px]"
            style={{
              width: '1px',
              height: '3px',
              left: `${Math.random() * 100}%`,
              top: `${Math.random() * 100}%`,
              animation: `sandStorm ${Math.random() * 2 + 1}s linear infinite`,
...
function Achievements() {
  ...
  useEffect(() => {
    ...
    const bg = containerRef.current.querySelector('.motion-bg-layer');
    if (bg) {
      // Focus on sideways (horizontal) movement
      gsap.to(bg, {
        xPercent: 10,
        scaleX: 1.2, // Ensure width for the pan
        duration: 12,
        repeat: -1,
        yoyo: true,
        ease: "sine.inOut"
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="w-full max-w-none anim-box mb-16">
          ...
          <p className="mt-6 text-lg font-medium text-neutral-800 anim-content leading-relaxed lg:whitespace-nowrap">
        ...
        <div className="grid md:grid-cols-3 gap-16 md:gap-0 anim-grid relative pt-8">
          {columns.map((c, i) => (
            ...
            >
              ...
              {/* Pill & Title */}
              <span className="text-[#A67C33] text-[14px] font-bold uppercase tracking-[0.2em] mb-3 anim-content">
                {c.pill}
              </span>
              ...
              {/* Description */}
              <p className="text-neutral-900 font-medium leading-relaxed mb-12 max-w-[280px] anim-content text-sm">
                {c.body}
              </p>
              ...
              <div className="mt-auto relative inline-flex flex-col items-start text-left border-l-2 border-[#BFA77A] pl-4">
                ...
                <span className="text-[11px] font-bold text-black tracking-[0.2em] mt-1.5 uppercase">
                  {c.statLabel}
                </span>
                {/* Bottom Gold Line */}
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center anim-box">
        ...
        <p className="mt-6 text-lg font-medium max-w-2xl mx-auto anim-content">
...
function Index() {
  ...
  return (
    <div ref={mainRef} className="bg-white text-black overflow-x-hidden">
      <Nav />
      <main>
        <Hero />
        <Marquee />
